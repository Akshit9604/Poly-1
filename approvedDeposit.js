...
const ABI = require("../artifacts/contracts/monastery.sol/monastery.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("monastery");
  const nft = await NFT.attach("0xa8d947C4C9203C7d9Eb4efb91539E4fc0379B37D");
